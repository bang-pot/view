...
BangPot frontend 저장소입니다. 현재 저장소는 Common Ops 기반 위에 Common Error Contract frontend round 01 기준까지 반영되어 있습니다.
...
| `NEXT_PUBLIC_API_BASE_URL` | backend base URL | fallback 허용 | 필수 |
...
- backend가 공통 실패 응답 계약을 지키지 않은 예외 상황에서만 fallback `code/message`를 사용합니다.
